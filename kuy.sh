...
ctrl_c() {
	...
	sleep 1
	echo ""
	echo -e $green" Terimakasih Udah Pake Tools Ini :) "
	sleep 1
	echo ""
...
figlet -f slant 'PaketDeface ++' | lolcat

sleep 1
echo "⛧ Paket Lengkap Untuk Dipes ⛧"
sleep 1
echo "♛ Recode By : Skyw4lkeR77"
sleep 1
echo "♛ github : https://github.com/Skyw4lkeR77"
sleep 1
echo "♛ Gunakan Dengan Bijak Yaa ^_^"

echo -e $red" Salam Dari Binjai ! "

echo ""

echo -e $white " ☟ Pilih Tools Untuk Diinstal ☟ :"
...
echo "[✔] All is done! [✔]"
echo "[✔] Sekarang Kamu Bisa menjalankan module ini [✔]"
...
then
clear
echo -e $red " Terimakasih Udah Pake Tools Ini :) "
sleep 1
echo -e $red " Semoga Kalian Senang Dengan Tools Saya ;) "
sleep 1
echo -e $red " Okey Do not Forget to Move Again "
sleep 1
echo -e $red " ⛧ Skyw4lkeR77 ⛧ "
sleep 1
echo -e $white " Salam Dari Binjai ! "
sleep 1
exit
fi
